...
public class TwoActorRequestLocators {
	...
	public static By calendarField = By.xpath("//input[@id='dueDate']");
	public static By calendarArea = By.cssSelector(".slds-dropdown.slds-dropdown--left.slds-datepicker.ng-scope");
}
